...
export function RecenterButton() {
  ...
  return (
    <button
      ...
      className="absolute bottom-20 right-4 z-[1000] w-12 h-12 bg-white rounded-full shadow-lg border border-border/30 flex items-center justify-center text-primary hover:bg-primary hover:text-white hover:shadow-xl hover:scale-110 active:scale-95 transition-all duration-200"
    >
